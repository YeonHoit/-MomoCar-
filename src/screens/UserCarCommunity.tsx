...
export default function UserCarCommunity() {
  // prettier-ignore
  ...
  const refresh = useCallback(() => {
    ...
    data.append('BoardName', user.UserCarType)
    ...
    post('1.0.1/GetCommunityList.php', data)
      ...
      .catch((e) => {
        setAlertMessage('글 목록을 가져오지 못했습니다')
        setShowAlert(true)
  ...
  return (
    <>
      ...
      <Pressable
        ...
        onPress={() =>
          navigation.navigate('WritePost', {boardName: user.UserCarType})
        }>
        <FastImage
