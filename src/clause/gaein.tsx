  ...
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: 'white'}}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <Text>
          {'<'} 커스트(Coust) {'>'}('momocar.net'이하 '모모카')은(는) 「개인정보
          ...
          {'\n'}제1조(개인정보의 처리 목적){'\n'}
          {'\n'}
          {'<'} 커스트(Coust) {'>'}('momocar.net'이하 '모모카')은(는) 다음의
          ...
          동의일로부터{'<'}회원탈퇴시까지{'>'}까지 위 이용목적을 위하여
          보유.이용됩니다.{'\n'}
          {'\n'}
          보유근거 : 업체와 사용자의 중개 서비스 활용{'\n'}
          {'\n'}
          관련법령 :{'\n'}
          {'\n'}
          예외사유 :{'\n'}
          ...
          {'\n'}① 정보주체는 커스트(Coust)에 대해 언제든지 개인정보
          열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.{'\n'}
          {'\n'}② 제1항에 따른 권리 행사는커스트(Coust)에 대해 「개인정보
          보호법」 시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을
          통하여 하실 수 있으며 커스트(Coust)은(는) 이에 대해 지체 없이
          조치하겠습니다.
          {'\n'}
          ...
          {'\n'}
          {'\n'}⑥ 커스트(Coust)은(는) 정보주체 권리에 따른 열람의 요구,
          ...
          {'\n'}
          {'\n'}
          필수항목 : 휴대전화번호, 이름, 서비스 이용 기록, 접속 로그, 결제기록
          {'\n'}
          {'\n'}
          선택항목 : 이메일, 성별, 생년월일{'\n'}
          {'\n'}
          제5조(개인정보의 파기){'\n'}
          {'\n'}① {'<'} 커스트(Coust) {'>'} 은(는) 개인정보 보유기간의 경과,
          ...
          1. 파기절차{'\n'}
          {'\n'}
          {'<'} 커스트(Coust) {'>'} 은(는) 파기 사유가 발생한 개인정보를
          선정하고, {'<'} 커스트(Coust) {'>'} 의 개인정보 보호책임자의 승인을
          받아 개인정보를 파기합니다.{'\n'}
          {'\n'}
          2. 파기방법{'\n'}
          {'\n'}
          ...
          제6조(개인정보의 안전성 확보 조치){'\n'}
          {'\n'}
          {'<'} 커스트(Coust) {'>'}은(는) 개인정보의 안전성 확보를 위해 다음과
          같은 조치를 취하고 있습니다.{'\n'}
          {'\n'}
          ...
          {'\n'}
          커스트(Coust) 은(는) 정보주체의 이용정보를 저장하고 수시로 불러오는
          ‘쿠키(cookie)’를 사용하지 않습니다.{'\n'}
          {'\n'}
          제8조 (개인정보 보호책임자){'\n'}
          {'\n'}① 커스트(Coust) 은(는) 개인정보 처리에 관한 업무를 총괄해서
          ...
          직급 :대표{'\n'}
          {'\n'}
          연락처 :01029281477, 01036903932, coust2121@gmail.com,
          dldbsrjf@naver.com, x{'\n'}
          {'\n'}※ 개인정보 보호 담당부서로 연결됩니다.
          {'\n'}
          {'\n'}▶ 개인정보 보호 담당부서{'\n'}
          {'\n'}
          ...
          담당자 :서연호{'\n'}
          {'\n'}
          연락처 :01040553815, pdbx12@gmail.com, x{'\n'}
          {'\n'}② 정보주체께서는 커스트(Coust) 의 서비스(또는 사업)을
          이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제
          등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수
          있습니다. 커스트(Coust) 은(는) 정보주체의 문의에 대해 지체 없이 답변
          및 처리해드릴 것입니다.{'\n'}
          {'\n'}
          제9조(개인정보 열람청구){'\n'}
          {'\n'}
          ...
          아래의 부서에 할 수 있습니다.{'\n'}
          {'\n'}
          {'<'} 커스트(Coust) {'>'}은(는) 정보주체의 개인정보 열람청구가
          신속하게 처리되도록 노력하겠습니다.{'\n'}
          {'\n'}▶ 개인정보 열람청구 접수·처리 부서{'\n'}
          {'\n'}
          부서명 : 개발팀{'\n'}
