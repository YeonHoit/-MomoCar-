...
import type {Review, AttractionReview} from '../type'
...
// 리뷰 컴포넌트 매개변수 정의
export type ReviewComponentPlusIconProps = {
  reviewInfo: Review | AttractionReview // 리뷰 정보
  iconPress: () => void // 신고 아이콘 클릭 이벤트 함수
}

// 리뷰 컴포넌트 정의
export const ReviewComponentPlusIcon: FC<ReviewComponentPlusIconProps> = ({
  reviewInfo,
  iconPress
}) => {
      ...
      <View style={[styles.infoView]}>
        ...
        <View style={{alignItems: 'flex-end'}}>
          ...
          <Text style={[styles.dateText]}>
            {momentCal(reviewInfo.WriteDate)}
          </Text>
        </View>
      </View>
      {/* 리뷰 사진 */}
